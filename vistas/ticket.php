              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">
                            Nota de venta&nbsp;&nbsp;<button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)">
                              <i class="fa fa-plus-circle"></i>&nbsp;&nbsp;Agregar</button></h1>
                              <a target="_blank" href="cliente.php"> <button  class="btn btn-success"><i class="fa fa-users"></i> Clientes</button></a>
